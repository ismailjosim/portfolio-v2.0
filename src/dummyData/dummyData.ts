...
export const projectsSectionData: Project[] = [
  {
    ...
    badges: ['Redux', 'Express.js', 'Cloudinary', 'Nodemailer', 'JWT', 'Google OAuth', 'Vercel'],
    githubUrl: 'https://github.com/ismailjosim/tour-management-system-client.git',
  },
  {
    emoji: '🎓',
    name: 'EDU PLATFORM',
    ...
    badges: ['React', 'Next.js', 'Node.js', 'Express', 'MongoDB', 'Firebase', 'Stripe'],
    reverse: true,
