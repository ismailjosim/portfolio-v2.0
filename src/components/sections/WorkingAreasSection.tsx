	...
	return (
		...
		>
			<div className="w-full">
				<FadeUp>
					<p className="text-xs font-semibold tracking-widest uppercase text-accent mb-2">What I do</p>
				...
				<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
					{areas.map((area, i) => (
						<FadeUp key={area.title} delay={i * 80}>
							<Card
								className="group flex flex-col p-8 h-full cursor-pointer border border-border hover:border-accent hover:shadow-xl transition-all duration-300"
							>
								{/* Icon */}
								<div
